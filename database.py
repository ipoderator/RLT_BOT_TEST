...
class Video(Base):
    ...
    def __repr__(self):
        return f"<Video(id={self.id}, creator_id={self.creator_id}, views={self.views_count})>"
...
def init_db(database_url: str):
    ...
    """
    # Убираем префикс asyncpg если есть, используем синхронный драйвер для миграций
